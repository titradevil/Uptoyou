...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "tihtra"
  # spec.authors            = { "tihtra" => "artdevil.t.t@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/tihtra"
  ...
  spec.source       = { :git => "http://EXAMPLE/Uptoyou.git", :tag => "#{spec.version}" }
